...
""", (my_club_id,))
    ...
    grouped = {
        "GK": squad_df[squad_df["position_group"] == "GK"].sort_values("overall", ascending=False),
        "DF": squad_df[squad_df["position_group"] == "DF"].sort_values("overall", ascending=False),
        "MF": squad_df[squad_df["position_group"] == "MF"].sort_values("overall", ascending=False),
        "FW": squad_df[squad_df["position_group"] == "FW"].sort_values("overall", ascending=False),
    }
